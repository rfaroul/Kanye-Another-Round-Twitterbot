 ...
 "What I am interested in talking about is how race affects the way people perceive and respond to his vanity. ", //109
  "Kanye is a part of a long tradition of black artists for whom self-love is a political act. ", //92
   "it can be hard to catch that Kanye speaks almost from a populist perspective ", //77
    ...
    "This is why it’s so critical to really think about how and why folks are calling him “crazy.” ", //94
    "To continuously label what Kanye says as “crazy” is to dismiss him as not worth understanding. ", //95
    "black artists have used wit and satire to capture their exasperations and make light of the world’s absurdities. ", //113
    "despite the boundaries of a racist world that strangles your view of what is possible, you will love yourself excessively ", //122
    "for black folks to love themselves is a political act. ", //55
    "Kanye’s “vanity” is meant to be inspiring; it is not a mindless arrogance but it is pointed and intentional.", //108
    "black artists have used art and fashion to re-imagine the possibilities of what is possible for black identities. ", //114
    "this balance between the political and the beautiful has been characteristic of his discography. ", //97
    "Kanye has helped change the game entirely for how black men are allowed to express their vulnerabilities in public. ", //116
    "If you see him simply as a crazy egomaniac, you’ve taken away his right to be a dimensional human being. ", //105
    "You miss the moments when he is so boldly asserting his vulnerabilities, his anxieties, his humanity ", //101
    "This bravado mixed with a deeply sincere self-reflectiveness has characterized his career from the very beginning. ", //115
    "It’s hard to imagine the sappy crooning of Drake or the angsty emo rap of Kid Cudi existing if it weren’t for Kanye. ", //117
    "He’s keenly aware of the way black masculinity is wedded to a static image, and he purposefully plays with that. ", //113
    "ultimately, I am grateful for the space that his unapologetically vain work has created for black artists, for dreamers ", //120
    "At what point does being proud of yourself turn into being “too vain”? Who decides? "] //84;

    for (var i =0; i < quotes.length; i++) {
    	console.log(quotes[i], quotes[i].length);
    };

    var hebenQuotes = quotes[Math.floor(Math.random() * quotes.length)];
    //console.log("randomly generated heben quotes", hebenQuotes);
